...
<html>
  <head>
    ...
    <script src="dist/js/ver_especies.js?v=<?php echo $version ?>"></script>
    
  </head>

  <body
    onload="busca_productos(null);pone_tipos();"
  >
    ...
    <div id="ModalAgregarProducto" class="modal">
      ...
      <div class="box box-primary">
          ...
          <div class="box-body">
            ...
            <div class="form-group form-dias-produccion-especie">
              <div class="row">
                <div class="col">
                  ...
                  <div class="select-editable">
                    ...
                    <input type="search" autocomplete="off" maxlength="3" class="form-control" id="dias-produccion-especie" type="search" autocomplete="off">
                  </div>
                </div>
              </div>
            </div>
