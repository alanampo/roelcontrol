    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          <div class="row">
            <div class="col-3">
              <div class="d-flex flex-row">
                ...
                <select id="select_tipo" class="selectpicker mobile-device ml-3 w-75"
                  title="Selecciona Tipo de Producto" data-style="btn-info" data-live-search="true"
                  onChange="busca_productos(this.value);"></select>
              </div>
            </div>
            <div class="col-3">
            ...
            <div class="col text-right">
              <div class="d-flex flex-row justify-content-end" style="gap:5px">
                <button class="btn btn-primary btn-round" onclick="modalAtributos()">Atributos</button>

                <button class="btn btn-success btn-round" onclick="pone_tipos();MostrarModalAgregarProducto(null);"><i
                    class="fa fa-plus-square"></i> Variedad</button>
              </div>
          ...
          <div class="row mt-2">
            <div class="col">
              <button class="btn btn-sm btn-primary" onclick="exportarVariedades()"><i class="fa fa-save"></i> EXPORTAR
                A CSV</button>
            </div>
          </div>
          ...
          <div class="form-group">
            <div class="row">
              <div class="col">
                ...
                <select id="select_tipo2" class="selectpicker mobile-device w-100" title="Tipo de Producto"
            ...
            <div class="row">
              <div class="col">
                ...
                <div class="select-editable">
                  <select class="form-control" id="select-dias-produccion"
                  ...
                  <input type="search" autocomplete="off" maxlength="3" class="form-control"
                    id="dias-produccion-variedad" type="search" autocomplete="off">
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col">
              <div class="table-responsive">
                <table id="table-atributos" class="table table-bordered table-light w-100">
                  <thead class="thead-dark">
                    <tr>
                      <th scope="col">Nombre</th>
                      <th style="max-width: 400px !important" scope="col">Valor</th>
                    </tr>
                  </thead>
                  <tbody></tbody>
                </table>
