...
<head>
  ...
  <script src="dist/js/ver_laboratorio.js?v=<?php echo uniqid() ?>"></script>
</head>
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          <div class="row">
            <div class="col-md-9">
              <div class="tab">
                <button id="defaultOpen" class="tablinks" onclick="openTab(event, 'tab-invitro');">Laboratorio</button>
              </div>
            </div>
            <div class="col-md-3">
