...
if ($consulta == "cargar_pedidos") {
    try {
        ...
        $arraypedidos = array();
        if ($tipo == "planta-terminada") {
            $tipo_producto = "'PT'";
        } else if ($tipo == "bolsa") {
            $tipo_producto = "'BOL'";
        }
        else if ($tipo == "arboles") {
            $tipo_producto = "'ARB'";
        }
        else if ($tipo == "planta") {
            $tipo_producto = "'PLA'";
        ...
        WHERE ap.eliminado IS NULL AND ((ap.estado >= 0 AND ap.estado <= 6) OR ap.estado = 60) AND t.codigo = $tipo_producto
        $strbusqueda
